...
> 火山方舟豆包 Seedance 1.0 Lite 文生视频模型，仅支持文本生成视频，默认 720p。
...
|------|------|------|--------|----------|------|
| model | string | 是 | — | `doubao-seedance-1-0-lite-t2v-250428` | 模型ID |
| content | array | 是 | — | — | 输入内容列表 |
| content[].type | string | 是 | — | `text` | 内容类型 |
| content[].text | string | 是 | — | — | 文本提示词 |
