...
# Seedance 1.0 Pro Fast 视频生成

> 火山方舟豆包 Seedance 1.0 Pro Fast 视频生成模型，支持文生视频和首帧图生视频，默认 1080p，更快的生成速度。
...
|------|------|------|--------|----------|------|
| model | string | 是 | — | `doubao-seedance-1-0-pro-fast-251015` | 模型ID |
...
| content[].role | string | 条件 | — | `first_frame` | 图像角色（仅支持首帧） |
