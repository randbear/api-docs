---
title: doubao-seed-1.6-vision 对话模型
provider: volcengine
model_id: doubao-seed-1-6-vision-250815
task: chat
---

# doubao-seed-1.6-vision 对话模型

> 豆包 seed 1.6 视觉增强版模型，支持深度思考、多模态理解、GUI 任务处理，适合视觉理解和自动化操作场景。
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|------|--------|------|
| model | string | 是 | — | `doubao-seed-1-6-vision-250815` |
