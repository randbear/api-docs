---
title: doubao-seed-1.8 对话模型
provider: volcengine
model_id: doubao-seed-1-8-251228
task: chat
---

# doubao-seed-1.8 对话模型

> 豆包最强多模态 Agent 模型，更强 Agent 能力，多模态理解升级，支持深度思考。
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|------|--------|------|
| model | string | 是 | — | `doubao-seed-1-8-251228` |
...
|----------------------|------|----------|----------|
| [0, 32] | 输出长度 [0, 0.2]k | 0.80 | 2.00 |
| [0, 32] | 输出长度 (0.2, +∞)k | 0.80 | 8.00 |
| (32, 128] | — | 1.20 | 16.00 |
| (128, 256] | — | 2.40 | 24.00 |
