...
> 基于首帧图像和可选文本提示词生成视频，支持 480P/720P/1080P 多种分辨率和 5 秒或 10 秒时长。
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|------|--------|------|
| model | string | 是 | - | 固定为 `wan2.5-i2v-preview` |
| input.img_url | string | 是 | - | 首帧图像 URL 或 Base64。图像要求：每边 360~2000 像素，文件 ≤10MB，支持格式：JPEG、JPG、PNG、BMP、WEBP |
...
| input.template | string | 否 | - | 视频效果模板 |
| parameters.resolution | string | 否 | `"1080P"` | 视频分辨率，可选 `480P`、`720P`、`1080P` |
