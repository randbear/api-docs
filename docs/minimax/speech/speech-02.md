---
title: MiniMax Speech 02 语音合成
provider: minimax
model_id: speech-02-hd / speech-02-turbo
task: text-to-speech
---

# MiniMax Speech 02 语音合成

> MiniMax Speech 02 语音合成模型，稳定性强，音色还原度高，turbo 版增强小语种支持，40+ 语言。

## 模型信息

| 属性 | 值 |
|------|-----|
| 模型ID | `speech-02-hd`（高清，稳定性强）/ `speech-02-turbo`（快速，增强小语种） |
| 任务类型 | text-to-speech |
...
|------|------|------|--------|----------|------|
| model | string | 是 | — | `speech-02-hd` / `speech-02-turbo` | 模型ID |
...
| 模型 | 价格 |
|------|------|
| speech-02-hd | ¥3.5/万字符 |
| speech-02-turbo | ¥2/万字符 |
