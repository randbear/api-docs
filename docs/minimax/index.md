...
MiniMax 开放平台提供文本生成、视频生成、语音、图像、音乐等多模态能力。
...
数据来源：[MiniMax 按量计费](https://platform.minimaxi.com/docs/guides/pricing-paygo)、[MiniMax 语音资源包](https://platform.minimaxi.com/docs/guides/pricing)
